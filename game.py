    ...
    while game_on:
        ...
        if user_choice == "Q":
            ...
            if user_choice == "R" and computer_choice == "S":
                ...
                print("Congrats, you win. Scisser cuts Paper")
            elif user_choice == "R" and computer_choice == "P":
                print("So sorry, computer wins. Paper covers Rock")
            elif user_choice == "S" and computer_choice == "R":
                print("So sorry, computer wins. Rock beats Scisser")
            elif user_choice == "P" and computer_choice == "S":
                print("So sorry, computer wins. Scisser cuts Paper")
            elif user_choice == computer_choice:
                print(f"Wow! It's a Draw. Both you and computer selected {get_choice(user_choice)}")
            else:
                print("Invaild option: Please enter [R, P, S or Q] only")
